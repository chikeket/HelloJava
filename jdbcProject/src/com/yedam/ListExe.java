...
public class ListExe {
	public static void main(String[] args) {
		...
		Student s2 = new Student(2000, "최민정", "010-0000-1111", "B"); //인스턴스
		stdList.add(s1);
		stdList.add(s2);
		stdList.add(new Student(3000, "최우식", "010-0000-2222", "A"));
		
		for(int i=0; i<stdList.size(); i++) {
			System.out.println("학번: "+ stdList.get(i).getStdNo() + ",이름:"+stdList.get(i).getStdName() + ",전화번호:"+stdList.get(i).getPhone()+",혈액형:"+stdList.get(i).getBloodType());
		}
